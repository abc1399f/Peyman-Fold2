...
data_dir = os.path.join( '/content/Peyman-Fold2/data/Fold2/')
...
output_dir = './content/Peyman-Fold2/output/'
...
def evaluate(model, predict_dataloader, batch_size, epoch_th, dataset_name):
    ...
    with open("/content/Peyman-Fold2/data/Fold2/train.txt", "w") as writer:
            ...
            nextfile=open("/content/Peyman-Fold2/data/Fold2/valid.txt", "w")
